...
export const SecurityLabView: React.FC = () => {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      {/* Notion Coral Hero Container */}
      <div className="notion-block-coral p-6 md:p-8 space-y-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2.5">
              <div className="p-2 rounded-xl bg-[#FFFFFF] border border-[#FFD0D0] text-[#E11D48] shadow-2xs">
          ...
          <button
            ...
            className="px-5 py-2.5 bg-[#2383E2] hover:bg-[#1D74CB] text-white font-mono text-xs font-bold rounded-lg flex items-center gap-2 shadow-xs transition-all active:scale-95 self-start md:self-auto"
          >
          ...
          <div className="notion-card p-6 space-y-5">
            <div className="flex items-center justify-between border-b border-[#E9E8E4] pb-3">
              <div className="flex items-center space-x-2">
                <SlidersHorizontal className="w-4 h-4 text-[#2383E2]" />
                <h3 className="text-sm font-bold text-[#000000] uppercase tracking-wider font-mono">
                  Schema Builder & Context Simulator
                </h3>
              </div>
              <span className="text-[11px] font-mono text-[#2383E2] font-semibold">Inputs & Attributes</span>
            </div>

            {/* User Persona Selector */}
            <div className="space-y-1.5">
              <label className="text-xs font-mono font-bold text-[#37352F] uppercase tracking-wider block">
              ...
              <select
                ...
                className="w-full bg-[#F7F6F3] border border-[#E9E8E4] rounded-xl px-3.5 py-2 text-xs font-mono text-[#37352F] focus:outline-none focus:ring-2 focus:ring-[#2383E2] font-medium"
              >
            ...
            <div className="p-4 rounded-xl bg-[#F7F6F3] border border-[#E9E8E4] space-y-2">
              <div className="flex items-center justify-between text-xs font-mono">
                <span className="font-bold text-[#37352F]">3. Evaluated Clearance Level: Level {clearanceLevel}</span>
                <span className="font-bold text-[#2383E2]">Req: Level {currentDocObj.minLevel}</span>
              </div>
              <input
                type="range"
                min="1"
              ...
              />
              <div className="flex items-center justify-between text-[9px] font-mono text-[#787774]">
                <span>L1 Public</span>
            ...
            <div className="space-y-1.5">
              ...
              <div className="text-[10px] font-mono text-[#787774]">
                Required for target doc: <strong className="text-[#2383E2]">{currentDocObj.allowed.join(', ') || 'None (Public)'}</strong>
              </div>
            </div>
          </div>

          {/* Right Column: Live Decision Engine & JSON Generator */}
          <div className="notion-card p-6 space-y-5 flex flex-col justify-between">
            <div className="space-y-4">
              <div className="flex items-center justify-between border-b border-[#E9E8E4] pb-3">
                <div className="flex items-center space-x-2">
                  <Terminal className="w-4 h-4 text-[#2383E2]" />
                  <h3 className="text-sm font-bold text-[#000000] uppercase tracking-wider font-mono">
                    Live Decision Engine & JSON
                  </h3>
                </div>
                <button
                  onClick={handleCopyJSON}
                  className="inline-flex items-center space-x-1 px-2.5 py-1 rounded-lg bg-[#F1F0EC] hover:bg-[#E3E2E0] border border-[#D9D8D5] text-xs font-mono text-[#37352F] transition-colors"
                >
              ...
              {/* Live Terminal Log */}
              <div className="p-3 rounded-xl bg-[#F7F6F3] text-[#37352F] font-mono text-xs space-y-1 border border-[#E9E8E4]">
                <div className="text-[10px] text-[#787774] uppercase tracking-wider flex items-center gap-1.5 font-bold">
                  <Zap className="w-3 h-3 text-[#2383E2]" />
                  <span>Live Audit Evaluation Trace</span>
                </div>
                <p className="text-[#00A884] font-mono text-[11px] leading-relaxed pt-1">
                  {evalLog}
                </p>
              </div>
              ...
              <div className="space-y-1.5">
                <div className="text-[10px] font-mono text-[#787774] uppercase tracking-wider font-bold">
                  Exportable Evaluator Decision Payload
                </div>
                <pre className="p-4 rounded-xl bg-[#F7F6F3] text-[#37352F] font-mono text-xs overflow-x-auto leading-relaxed border border-[#E9E8E4] max-h-64">
